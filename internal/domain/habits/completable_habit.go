...
// NewCompletableHabit returns a completable habit with validated fields or domain validation violations.
func NewCompletableHabit(rawLabel string, rawIcon int, accountId uuid.UUID) (*CompletableHabit, domain.Violations) {
